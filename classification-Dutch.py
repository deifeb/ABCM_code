...
# df = pd.read_excel(r"E:\数据集\荷兰制造公司3451件商品销售情况\manufacturing_dataset.xlsx", sheet_name="Sheet1")
# df_non_zero = df.loc[:, (df != 0).any(axis=0)]
# data = df_non_zero.iloc[:, 2:]
